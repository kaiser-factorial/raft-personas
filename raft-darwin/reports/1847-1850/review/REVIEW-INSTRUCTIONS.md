# Full-source review: 1847–1850

The research endpoint is 24 November 1859, but this assignment covers only its
specified 1847–1850 packet. Work backwards from Charles Robert Darwin's outgoing
...
are dating investigations, not admitted 1847–1850 persona material. Seek an
...
```
/Users/corinakaiser/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 scripts/period_review.py --period 1847-1850 --batch batch-01 --offset 0 --limit 2
```
...
```
/Users/corinakaiser/.cache/codex-runtimes/codex-primary-runtime/dependencies/python/bin/python3 scripts/period_review.py --period 1847-1850 --validate reports/1847-1850/review/reviews/batch-NN.json
```
...
The prior checkpoint is reports/research/1844-1846-checkpoint.primary.json. Prior primary decisions live under data/annotations/periods/1844-1846 and reports/1844-1846/review/parent-reading. Repeated record IDs may reuse explicit primary reading only when both raw HTML/XML hashes match; prior-period acceptance never proves new-period chronological eligibility. Preserve prior relationships as already recorded, without recounting them. Context packet selection is not a claim that those letters existed or were known by a target date.
